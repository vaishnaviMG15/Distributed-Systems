...
public class RUStoreClient {
	...
	/**
	 * 
	 * helper method to form a string that has 1024 characters
	 * The initial characters will be the input key.
	 * Then it will be padded with 0's at the end.
	 * 
	 */
	/*private static String encodeKey(String key) {
		...
		//System.out.println("Result in encode_key: " + result);
